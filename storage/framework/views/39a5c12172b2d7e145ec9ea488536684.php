<?php $__env->startSection('title', 'My Profile - Caldera'); ?>
    ...
    <div class="row g-4">
            ...
            <div class="card border-0 shadow-sm caldera-sidebar-card">
                <div class="card-body text-center p-4">
                    <div class="profile-avatar mb-3">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(Auth::user()->name); ?>&background=c1a067&color=fff&size=100&rounded=true" 
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('customer.profile')); ?>" class="btn btn-sidebar active">
        ...
        <div class="col-md-8 col-lg-9">
                    ...
                    <form method="POST" action="<?php echo e(route('customer.profile.update')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="phone" class="form-control caldera-input" 
                                   value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="0812-3456-7890">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control caldera-input" 
                                   value="<?php echo e($user->created_at->format('d F Y')); ?>" disabled>
                        </div>
            ...
            <div class="card border-0 shadow-sm caldera-form-card">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('customer.password.change')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PA_03\PA2\resources\views/customer/profile.blade.php ENDPATH**/ ?>